...
WORDPRESS_ADMIN_EMAIL = prompt_input("Enter WORDPRESS_ADMIN_EMAIL (e.g., anything@gmail.com): ", "ramoussa@wordpress.com")
...
WORDPRESS_EDITOR_EMAIL = prompt_input("Enter WORDPRESS_EDITOR_EMAIL (e.g., anything@editors.com): ", "editor@wordpress.com")
